...
<div class="wizard-step" data-step="13">
    ...
    <div class="color-schemes" id="colorSchemesContainer">
            ...
            <div class="color-scheme" data-scheme="sage-green">
                ...
                <div class="color-palette">
                    <div class="color-swatch" style="background: #8FA88F;" title="Primary"></div>
            ...
            <div class="color-scheme" data-scheme="soft-lavender">
                ...
                <div class="color-palette">
                    <div class="color-swatch" style="background: #7B88B5;" title="Primary"></div>
            ...
            <div class="color-scheme" data-scheme="warm-rose">
                ...
                <div class="color-palette">
                    <div class="color-swatch" style="background: #D4877B;" title="Primary"></div>
            ...
            <div class="color-scheme" data-scheme="warm-blue-apricot">
                ...
                <div class="color-palette">
                    <div class="color-swatch" style="background: #7A93A8;" title="Primary"></div>
            ...
            <div class="color-scheme" data-scheme="clear-blue">
                ...
                <div class="color-palette">
                    <div class="color-swatch" style="background: #5B8CB8;" title="Primary"></div>
            ...
            <div class="color-scheme" data-scheme="deep-terracotta">
                ...
                <div class="color-palette">
                    <div class="color-swatch" style="background: #A85840;" title="Primary"></div>
            ...
            <div class="color-scheme" data-scheme="soft-mauve">
                ...
                <div class="color-palette">
                    <div class="color-swatch" style="background: #A8859B;" title="Primary"></div>
        ...
        <div class="demo-preview" id="demoPreview">
            ...
            <div class="preview-content">
                ...
                <div class="preview-text" id="previewText3" style="width: 60%; margin-left: auto; margin-right: auto;"></div>
            </div>
        </div>
